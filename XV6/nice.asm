...
main(int argc, char *argv[])
{
  ...
  71:	53                   	push   %ebx
  72:	56                   	push   %esi
  73:	e8 fa 02 00 00       	call   372 <chpr>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3bf:	f7 f6                	div    %esi
 3c1:	0f b6 92 8c 07 00 00 	movzbl 0x78c(%edx),%edx
  }while((x /= base) != 0);
...
free(void *ap)
{
 ...
 617:	89 08                	mov    %ecx,(%eax)
  freep = p;
 619:	a3 2c 0a 00 00       	mov    %eax,0xa2c
}
 61e:	5b                   	pop    %ebx
 61f:	5e                   	pop    %esi
 620:	5f                   	pop    %edi
 ...
 63a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 63d:	a3 2c 0a 00 00       	mov    %eax,0xa2c
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 6af:	76 3f                	jbe    6f0 <malloc+0xa0>
    ...
    if(p == freep)
 6b1:	39 05 2c 0a 00 00    	cmp    %eax,0xa2c
 ...
 6d6:	e8 e5 fe ff ff       	call   5c0 <free>
  return freep;
 6db:	8b 15 2c 0a 00 00    	mov    0xa2c,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 6fc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 6ff:	89 15 2c 0a 00 00    	mov    %edx,0xa2c
      return (void*)(p + 1);
 ...
 714:	eb e9                	jmp    6ff <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 716:	c7 05 2c 0a 00 00 30 	movl   $0xa30,0xa2c
 71d:	0a 00 00 
 720:	c7 05 30 0a 00 00 30 	movl   $0xa30,0xa30
 727:	0a 00 00 
    base.s.size = 0;
 72a:	b8 30 0a 00 00       	mov    $0xa30,%eax
 72f:	c7 05 34 0a 00 00 00 	movl   $0x0,0xa34
 736:	00 00 00 
