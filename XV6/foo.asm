...
_foo:     formato del fichero elf32-i386
...
main(int argc, char *argv[])
{
  ...
  1c:	0f 8e bf 00 00 00    	jle    e1 <main+0xe1>
    n = 1;	//default value
  else
    n = atoi ( argv[1] ); //from commad line
  22:	83 ec 0c             	sub    $0xc,%esp
  25:	ff 76 04             	pushl  0x4(%esi)
  28:	e8 e3 02 00 00       	call   310 <atoi>
  if( n < 0 || n > 20)
  ...
  if( n < 0 || n > 20)
  35:	0f 86 ee 00 00 00    	jbe    129 <main+0x129>
    n = 2;
  ...
  if( argc < 3 )
  43:	0f 8e 8c 00 00 00    	jle    d5 <main+0xd5>
    d = 1.0;
  else
    d = atoi (argv[2]);
  49:	83 ec 0c             	sub    $0xc,%esp
  4c:	ff 76 08             	pushl  0x8(%esi)
  4f:	e8 bc 02 00 00       	call   310 <atoi>
  54:	89 45 e0             	mov    %eax,-0x20(%ebp)
  57:	83 c4 10             	add    $0x10,%esp
  5a:	db 45 e0             	fildl  -0x20(%ebp)
  5d:	dd 5d e0             	fstpl  -0x20(%ebp)

  x = 0;
  id = 0;
  for( k = 0; k < n; k++){
  60:	85 ff                	test   %edi,%edi
  62:	74 6c                	je     d0 <main+0xd0>
    n = 1;	//default value
  64:	31 db                	xor    %ebx,%ebx
  66:	eb 2c                	jmp    94 <main+0x94>
  68:	90                   	nop
  ...
  70:	74 7e                	je     f0 <main+0xf0>
      printf(1, "Parent %d creating child %d\n", getpid(), id );
  72:	e8 8b 03 00 00       	call   402 <getpid>
  77:	56                   	push   %esi
  78:	50                   	push   %eax
  for( k = 0; k < n; k++){
  79:	83 c3 01             	add    $0x1,%ebx
      printf(1, "Parent %d creating child %d\n", getpid(), id );
  7c:	68 14 08 00 00       	push   $0x814
  81:	6a 01                	push   $0x1
  83:	e8 58 04 00 00       	call   4e0 <printf>
      wait ();
  88:	e8 fd 02 00 00       	call   38a <wait>
  8d:	83 c4 10             	add    $0x10,%esp
  for( k = 0; k < n; k++){
  90:	39 fb                	cmp    %edi,%ebx
  92:	7d 3c                	jge    d0 <main+0xd0>
    id = fork (0);
  94:	83 ec 0c             	sub    $0xc,%esp
  97:	6a 00                	push   $0x0
  99:	e8 dc 02 00 00       	call   37a <fork>
    if( id < 0 ){
  ...
  a3:	89 c6                	mov    %eax,%esi
    if( id < 0 ){
  a5:	79 c9                	jns    70 <main+0x70>
      printf(1, "%d failed in fork!\n", getpid() );
  a7:	e8 56 03 00 00       	call   402 <getpid>
  ac:	83 ec 04             	sub    $0x4,%esp
  for( k = 0; k < n; k++){
  af:	83 c3 01             	add    $0x1,%ebx
      printf(1, "%d failed in fork!\n", getpid() );
  b2:	50                   	push   %eax
  b3:	68 00 08 00 00       	push   $0x800
  b8:	6a 01                	push   $0x1
  ba:	e8 21 04 00 00       	call   4e0 <printf>
  bf:	83 c4 10             	add    $0x10,%esp
  for( k = 0; k < n; k++){
  c2:	39 fb                	cmp    %edi,%ebx
  c4:	7c ce                	jl     94 <main+0x94>
  ...
  exit();
  d0:	e8 ad 02 00 00       	call   382 <exit>
    d = 1.0;
  d5:	d9 e8                	fld1   
    n = 2;
  d7:	bf 02 00 00 00       	mov    $0x2,%edi
    d = 1.0;
  dc:	dd 5d e0             	fstpl  -0x20(%ebp)
  df:	eb 83                	jmp    64 <main+0x64>
  e1:	d9 e8                	fld1   
    n = 1;	//default value
  e3:	bf 01 00 00 00       	mov    $0x1,%edi
    d = 1.0;
  e8:	dd 5d e0             	fstpl  -0x20(%ebp)
  eb:	e9 74 ff ff ff       	jmp    64 <main+0x64>
      printf(1, "Child %d created\n", getpid());
  f0:	e8 0d 03 00 00       	call   402 <getpid>
  f5:	52                   	push   %edx
  f6:	50                   	push   %eax
  f7:	68 31 08 00 00       	push   $0x831
  fc:	6a 01                	push   $0x1
  fe:	e8 dd 03 00 00       	call   4e0 <printf>
      for ( z = 0; z < 8000000.0; z += d )
 103:	d9 ee                	fldz   
      printf(1, "Child %d created\n", getpid());
 105:	83 c4 10             	add    $0x10,%esp
      for ( z = 0; z < 8000000.0; z += d )
 108:	d9 05 44 08 00 00    	flds   0x844
 10e:	d9 c9                	fxch   %st(1)
 110:	eb 08                	jmp    11a <main+0x11a>
 112:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
 118:	d9 c9                	fxch   %st(1)
 11a:	dc 45 e0             	faddl  -0x20(%ebp)
 11d:	d9 c9                	fxch   %st(1)
 11f:	db e9                	fucomi %st(1),%st
 121:	77 f5                	ja     118 <main+0x118>
 123:	dd d8                	fstp   %st(0)
 125:	dd d8                	fstp   %st(0)
 127:	eb a7                	jmp    d0 <main+0xd0>
  if( argc < 3 )
 129:	83 fb 02             	cmp    $0x2,%ebx
 12c:	0f 85 17 ff ff ff    	jne    49 <main+0x49>
    d = 1.0;
 132:	d9 e8                	fld1   
 134:	dd 5d e0             	fstpl  -0x20(%ebp)
 137:	e9 24 ff ff ff       	jmp    60 <main+0x60>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 47f:	f7 f6                	div    %esi
 481:	0f b6 92 50 08 00 00 	movzbl 0x850(%edx),%edx
  }while((x /= base) != 0);
 ...
 4ec:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 67b:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 680:	bb 48 08 00 00       	mov    $0x848,%ebx
...
free(void *ap)
{
 ...
 691:	a1 f4 0a 00 00       	mov    0xaf4,%eax
{
 ...
 6b6:	73 18                	jae    6d0 <free+0x40>
{
 ...
 6e7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6e9:	a3 f4 0a 00 00       	mov    %eax,0xaf4
}
 6ee:	5b                   	pop    %ebx
 6ef:	5e                   	pop    %esi
 6f0:	5f                   	pop    %edi
 ...
 70a:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 70d:	a3 f4 0a 00 00       	mov    %eax,0xaf4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 796:	e8 f5 fe ff ff       	call   690 <free>
  return freep;
 79b:	8b 15 f4 0a 00 00    	mov    0xaf4,%edx
 ...
 7d4:	eb e9                	jmp    7bf <malloc+0x9f>
    base.s.ptr = freep = prevp = &base;
 7d6:	c7 05 f4 0a 00 00 f8 	movl   $0xaf8,0xaf4
 7dd:	0a 00 00 
 7e0:	c7 05 f8 0a 00 00 f8 	movl   $0xaf8,0xaf8
 7e7:	0a 00 00 
    base.s.size = 0;
 7ea:	b8 f8 0a 00 00       	mov    $0xaf8,%eax
 7ef:	c7 05 fc 0a 00 00 00 	movl   $0x0,0xafc
 7f6:	00 00 00 
